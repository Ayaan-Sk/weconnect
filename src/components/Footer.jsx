      ...
      <div className="section-container">
        ...
        >
          ...
          >
            ...
            >
              ...
              <span className="text-xl font-medium ml-1">AlumNet</span>
            </motion.div>
            <motion.p 
              variants={fadeIn('up', 0.6)}
              className="text-gray-600 mb-6"
            >
              From Campus Bonds to Career Breakthroughs
            </motion.p>
            <motion.div 
        ...
        >
          ...
          >
            ...
            >
              Copyright © {new Date().getFullYear()} ayaanSheikh
            </motion.p>
            <motion.p 
              variants={fadeIn('left', 1.0)}
              className="text-gray-600 text-sm"
            >
              Created by Md Ayaan Sheikh
            </motion.p>
          </motion.div>
        </motion.div>
      </div>
